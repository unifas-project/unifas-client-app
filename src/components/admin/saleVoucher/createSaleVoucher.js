    ...
    const saleVoucherValidation = Yup.object().shape(
        {
            ...
            discount: Yup.number()
                ...
                .lessThan(101, "Discount must more than 0 and less than 100 percent")
                .test(
                    '',
                                ...
                                <Form >
                                    <div>
                                        <div className="form-group mt-4">
                                            <label htmlFor="code" className="form-label">Voucher's Code</label>
                                    ...
                                    <div className="form-group">
                                        <label htmlFor="discount" className="form-label">Voucher's Discount</label>
                                        <div>
                                    ...
                                    <footer className="d-flex">
                                        <Button type="reset" style={{backgroundColor: "black", maxHeight: "40px", marginRight:"2%"}}
                                                onClick={() => {
